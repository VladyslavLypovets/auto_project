            ...
            <div class="col-3">
              <div class="filter">
                ...
                <div class="manufacturer">
                  <div class="name-manufacturer d-flex align-items-center justify-content-between">
                    <h6>Производитель</h6>
                ...
                <div class="price">
                  <div class="name-price d-flex align-items-center justify-content-between">
                    <h6>Цена</h6>
                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                  </div>
                ...
                <div class="attribute">
                  <div class="name-attribute d-flex align-items-center justify-content-between">
                    <h6>Атрибут 1</h6>
                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                  </div>
            ...
            <div class="col-9">
              <div class="display-filter d-md-flex d-none justify-content-between">
                <div class="d-flex align-items-center">
                  <h6>Сортировать:</h6>
                  <div class="output-by">
                    <select class="nice-select  select-output-by">
                      <option value="рейтингу">По рейтингу</option>
                      <option value="Акционные">Акционные</option>
                      <option value="новизне">По новизне</option>
                      <option value="популярности">По популярности</option>
                      <option value="Отдешевых">От дешевых к дорогим</option>
                      <option value="Отдорогих">От дорогих к дешевым</option>
                    </select>
                  </div>
                </div>
                <div class="d-flex align-items-center">
                  <h6>Вид:</h6>
                  <div class="page-view" @change="val => activePage = val">
                    <button class="strings" @click="$emit('change', 1)">
                      <span></span>
                      <span></span>
                      <span></span>
                    </button>
                    <button class="blocks" @click="$emit('change', 2)">
